...
import_xlsx("Data",c("ATP","results", "sc"))
...
mass_coloc("2022-04-20-sc pFLIP-FUSE + 10 nM TOP2A_Top2a_ATP_results","2022-04-20-sc pFLIP-FUSE + 10 nM TOP2A_YOYO1_ATP_results","pFLIP_FUSE_supercoiled_10nM_Top2a_ATP")
